...
migrate((app) => {
  const collection = new Collection({
    ...
    "id": "pbc_2636233399",
    "indexes": [
      "CREATE UNIQUE INDEX `idx_tokenKey_va4hejmmx4` ON `pacientes` (`tokenKey`)",
      "CREATE UNIQUE INDEX `idx_email_va4hejmmx4` ON `pacientes` (`email`) WHERE `email` != ''"
    ],
    "listRule": null,
    "manageRule": null,
    "mfa": {
  ...
  const collection = app.findCollectionByNameOrId("pbc_2636233399");
